...
Point QuinticBezierPath::getPoint(double t) const {
  ...
  auto result = (T * coefficients) * controlPoints;
  return result(0);
}
...
Point QuinticBezierPath::getDerivative(double t) const {
  ...
  auto result = (T * firstDerivativeCoefficients) * controlPoints;
  return result(0);
}
...
Point QuinticBezierPath::getSecondDerivative(double t) const {
  ...
  auto result = (T * secondDerivativeCoefficients) * controlPoints;
  return result(0);
}
