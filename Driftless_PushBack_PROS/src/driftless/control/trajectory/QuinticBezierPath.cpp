...
QuinticBezierPath::QuinticBezierPath(Point start, Point c0, Point c1, Point c2,
  ...
  m_first_derivative_coefficients << 5, -25, 50, -50, 25, -5, 0, 20, -80, 120,
      -80, 20, 0, 0, 30, -90, 90, -30, 0, 0, 0, 20, -40, 20, 0, 0, 0, 0, 5, -5;

  // Calculate coefficients for the second derivative of the bezier curve
  m_second_derivative_coefficients << 20, -100, 200, -200, 100, -20, 0, 60,
      -240, 360, -240, 60, 0, 0, 60, -180, 180, -60, 0, 0, 0, 20, -40, 20;
}
...
void QuinticBezierPath::setControlPoint(int index, const Point point) {
  if (index >= 0 && index < 6) {
