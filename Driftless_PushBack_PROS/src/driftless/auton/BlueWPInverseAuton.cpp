...
BlueWPInverseAuton::BlueWPInverseAuton() : AAuton("B_WP_T->B") {}

void BlueWPInverseAuton::init(
...
void BlueWPInverseAuton::run(
  ...
  // go bottom goal
  goToPose(bottom_goal_lineup, MAX_VELOCITY, MAX_ANGULAR_VELOCITY / 5.0, 30.0);
  retractBackIntakeArms();
  waitForGoToPose(bottom_goal_lineup, 2.0, 2500);
  intakeStop();
