...
BlueTenBallLeftAuton::BlueTenBallLeftAuton() : AAuton("B_10B_L") {}

void BlueTenBallLeftAuton::init(
...
void BlueTenBallLeftAuton::run(
  ...
  retractBackIntakeArms();
  goToPose(long_goal, MAX_VELOCITY, MAX_ANGULAR_VELOCITY, 30.0);
  waitForGoToPose(long_goal, 20.0, 1000);
  intakeFront(12.0);
