...
OrangeWPInverseAuton::OrangeWPInverseAuton() : AAuton("O_WP_T->B") {}

void OrangeWPInverseAuton::init(
...
void OrangeWPInverseAuton::run(
  ...
  goToPose(line_blocks, MAX_VELOCITY / 5.0, MAX_ANGULAR_VELOCITY / 8.0);
