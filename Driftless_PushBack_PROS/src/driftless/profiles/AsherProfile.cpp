...
namespace driftless {
namespace profiles {
std::string AsherProfile::getName() { return PROFILE_NAME; }

int AsherProfile::getControlMode(op_control::EControlType control_type) const {
  int mode{};
...
void AsherProfile::setControlMode(op_control::EControlType control_type,
                                  int control_mode) {
  CONTROL_MODE_MAP[control_type] = control_mode;
}

op_control::EControllerAnalog AsherProfile::getAnalogControlMapping(
...
op_control::EControllerDigital AsherProfile::getDigitalControlMapping(
    op_control::EControl control) const {
...
bool AsherProfile::getStartupConfig(
