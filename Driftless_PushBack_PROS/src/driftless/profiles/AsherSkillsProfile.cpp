...
namespace driftless {
namespace profiles {
std::string AsherSkillsProfile::getName() { return PROFILE_NAME; }

int AsherSkillsProfile::getControlMode(
...
void AsherSkillsProfile::setControlMode(op_control::EControlType control_type,
                                        int control_mode) {
  CONTROL_MODE_MAP[control_type] = control_mode;
}

op_control::EControllerAnalog AsherSkillsProfile::getAnalogControlMapping(
...
op_control::EControllerDigital AsherSkillsProfile::getDigitalControlMapping(
    op_control::EControl control) const {
...
bool AsherSkillsProfile::getStartupConfig(
