...
void BackToBottomIntakeState::update(StateMachineIntake& intake) {
  ...
  if (intake.hasAllianceBlock(StateMachineIntake::ColorSortLocation::BACK) &&
    ...
    // check if we can see a second block and update flag
             ...
             intake.hasBlock(StateMachineIntake::ColorSortLocation::BACK)) {
    ...
    // direct blocks to the hood
             ...
             intake.hasAllianceBlock(
                 StateMachineIntake::ColorSortLocation::FRONT)) {
