#ifndef __FRONT_OUT_INTAKE_STATE_HPP__
#define __FRONT_OUT_INTAKE_STATE_HPP__
...
/// @brief Intake state for running the front intake motors backwards
/// @author Matthew Backman
class FrontOutIntakeState : public IIntakeState {
 public:
