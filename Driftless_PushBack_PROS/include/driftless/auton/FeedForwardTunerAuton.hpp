#ifndef __FEED_FORWARD_TUNER_AUTON_HPP__
#define __FEED_FORWARD_TUNER_AUTON_HPP__
...
/// point auton
/// @author Matthew Backman
class FeedForwardTunerAuton : public AAuton {
 private:
 public:
  /// @brief Constructs a new FeedForwardTunerAuton object
  FeedForwardTunerAuton();
