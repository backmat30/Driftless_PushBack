#ifndef __BLUE_CONTROL_RUSH_LEFT_HPP__
#define __BLUE_CONTROL_RUSH_LEFT_HPP__
...
class BlueControlRushLeftAuton : public AAuton {
 private:
  ...
  control::Point end_descore{19.0, 60.5, M_PI / 2.0};

 public:
  /// @brief Constructs a new blue pump n dump auton object
  BlueControlRushLeftAuton();
