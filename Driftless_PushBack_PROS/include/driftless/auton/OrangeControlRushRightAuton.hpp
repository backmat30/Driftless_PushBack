#ifndef __ORANGE_CONTROL_RUSH_RIGHT_AUTON_HPP__
#define __ORANGE_CONTROL_RUSH_RIGHT_AUTON_HPP__
...
class OrangeControlRushRightAuton : public AAuton {
 private:
  ...
  control::Point end_descore{127.0, 60.0, M_PI / 2.0};

 public:
  /// @brief Constructs a new blue pump n dump auton object
  OrangeControlRushRightAuton();
