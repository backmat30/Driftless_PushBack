#ifndef __BLUE_WIN_POINT_INVERSE_AUTON_HPP__
#define __BLUE_WIN_POINT_INVERSE_AUTON_HPP__
...
class BlueWPInverseAuton : public AAuton {
 private:
  ...
  control::Point matchload_lineup_2{28.0, 28.0, M_PI / 2.0};
  ...
  // middle goal points
  control::Point bottom_goal_lineup{62.0, 87.0, 0};

  control::Point bottom_goal{65.0, 83.0, -M_PI / 3.0};
  ...
  control::Point descore_2_end{36.0, 61.0, M_PI / 2};
